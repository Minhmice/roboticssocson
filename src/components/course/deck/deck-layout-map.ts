import type { DeckSlideLayout } from "@/data/arduinoMblockDeck";

/** One unique layout composition per slide (26 total). */
export const DECK_LAYOUT_BY_SLIDE_ID: Record<number, DeckSlideLayout> = {
  1: "cover-hero",
...
export function resolveDeckLayout(slideId: number, fallback: DeckSlideLayout): DeckSlideLayout {
  return DECK_LAYOUT_BY_SLIDE_ID[slideId] ?? fallback;
}
